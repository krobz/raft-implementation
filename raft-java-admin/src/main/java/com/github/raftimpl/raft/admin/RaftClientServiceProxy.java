...
public class RaftClientServiceProxy implements RaftClientService {
    ...
    // servers format is 10.2.2.2:8888
    ...
    @Override
    synchronized public RaftProto.AddPeersResponse addPeers(RaftProto.AddPeersRequest request) {
    ...
    @Override
    synchronized public RaftProto.RemovePeersResponse removePeers(RaftProto.RemovePeersRequest request) {
    ...
    synchronized private boolean updateConfiguration() {
